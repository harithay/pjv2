...
class EditableTextView extends React.Component {
	...
	render(){
		return <div data-id={this.props.data.cid} className="element editableText selectableParent selectable movable resizable  rotatable hasColor" style={this.styles().style} 
		...
		>
			<div className="editableContainer" onChange={this.control}  style={this.styles().editableContainer}
			onCopy = {this.control}
			onCut = {this.control}
			...
			//onKeyUp = {this.control}
						>
						<span style={{ "outline" : "0px solid transparent", "position" : "absolute"}} 
...
class ShapeCircleView extends React.Component {
	...
	render () {
		return <div data-id={this.props.data.cid} className="element shape circle selectableParent selectable movable resizable  rotatable hasColor" style={this.styles().style} onClick={this.handleClick}
		// Call the parent callbacks to handle move events of element
		onClick={this.handleClick}
		onMouseDown={this.handleMouseDown} 
		onTouchStart={this.handleMouseDown} 
		...
		>
			{
				this.props.data.get("children").map((element, key, index) => {
					...
					return <Type key={ cid } data={element} 
...
class ContainerView extends React.Component {
	...
	render () {
		return <div data-id={this.props.data.cid} className="collageRow" style={this.styles().style}>
			{
...
class ColumnView extends React.Component {
	...
	render () {
		return <div data-id={this.props.data.cid} className="collageColumn" style={this.styles().style}>
			{
				this.props.data.get("children").map((element, key) => {
					var cid = element.cid;
					var Type = ViewRegistry[element.get("type")]
...
class CellView extends React.Component {
	...
	render () {
		return <div style={this.styles().style} data-id={this.props.data.cid} key={this.props.data.cid } className="collageCell"  
					onClick={this.handleClick}>
				{
					this.props.data.get("children").map((element, key) => {
						var cid = element.cid;
...
class CellContentView extends React.Component {
	...
	render () {
		return <div data-id={this.props.data.cid} className="imageContainerCell catcher imageCatcher hasColor" style={ this.styles().style } 
				onClick={this.handleClick} 
				...
				>
				<div className="cellImageSelectionBlocker" style={{	textAlign: "center", width: "100%", height: "100%", position: "absolute", zIndex: "2"}}
				><span style={{opacity:"0", color:"rgba(0,0,0,0)",  top: "48%", position: "relative"}}>Double click to move image</span></div> 
				<div className="dropzone image-dropzone" style={{width: "100%", height: "100%", position: "absolute", zIndex: "2"}}
...
class CellImageView extends React.Component {
	...
	render () {
		return <img data-id={this.props.data.cid} className="cellImage" src={this.props.data.get("url")} style={this.styles().style} />
	};
	//componentDidUpdate () {
    //	this.props.data.updateStyleByElementSilently(ReactDOM.findDOMNode(this));
  	//}
...
class FixedCollageContainerView extends React.Component {
	...
	*/
	...
	render () {
		return <div data-id={this.props.data.cid} className="element fixedCollageContainer selectableParent hasColor" style={this.styles().style}  onClick={this.handleClick}
		// Call the parent callbacks to handle move events of element
...
class CollageContainerView extends React.Component {
	...
	render () {
		return <div data-id={this.props.data.cid} className="element collageContainer selectableParent selectable movable resizable  rotatable hasColor" style={this.styles().style}  onClick={this.handleClick}
		// Call the parent callbacks to handle move events of element
		//onMouseDown={this.props.onMouseDown } onMouseUp={this.props.onMouseUp } onMouseMove={this.props.onMouseMove } 
		onMouseDown={this.handleMouseDown} 
		onTouchStart={this.handleMouseDown} 
...
class ElementView extends React.Component {
	...
	render () {
		return <div data-id={this.props.data.cid} className="elements" style={this.styles().style}  
		 >
			{
...
class PageView extends React.Component {
	...
	render () {
		...
		return <section data-id={this.props.data.cid} className="page catcher" style={this.styles().page} 
			onMouseDown={this.handleMouseDown}
			onTouchStart={this.handleMouseDown}
		>
			<div className="page__clipArea"  style={this.styles().page__clipArea}>
				<div className="page__content" style={this.styles().page__content} >
				{
					this.props.data.get("children")[0].get("children").map((element, key) => {
						var cid = element.cid;
						var Type = ViewRegistry[element.get("type")]
						return <Type key={ cid } data={element} 
						onElementSelectionCallback={ this.props.onElementSelectionCallback }
			...
			<div className={this.props.additionalClassesForPageMove + " pageSidePanel"} data-page-id={this.props.data.cid}>
				<div className="vhcenter sidePanelTools" style={this.styles().page__sidebarContent}>
					<i className="material-icons tool">delete</i>
					<i className="material-icons tool upArrow">arrow_upward</i>
					<div className="pageNumber tool">{this.props.pageNumber + 1}</div>
					<i className="material-icons tool downArrow">arrow_downward</i>
				</div>
			</div>
		</section>
	};
...
class MultipageView extends React.Component {
	...
	render () {
		//Page set the offset from top coner.
		return <div className="multipage"  data-id={this.props.data.cid} style={this.styles().multipage}>
			{
				this.props.data.get("children").map((element, key) => {
					...
					var cid = element.cid;
					var Type = ViewRegistry[element.get("type")]
					return <Type key={ cid } data={element} pageNumber={key} additionalClassesForPageMove={additionalClassesForPageMove}
						onElementSelectionCallback={ this.props.onElementSelectionCallback }
						onElementMoveCallback = {this.props.onElementMoveCallback}
...
class SelectionBoxView extends React.Component {
	...
	handleMouseMoveOnResizeHandler(event){
		if(this.state && this.state.mousedown && this.state.mousedown.state){
			if(this.state.mousedown.event.target.classList.contains("handle") && 
			this.state.mousedown.selectableParentElement.classList.contains("resizable")){
				event.stopPropagation();	
	...
	render () {
		return <div className="selectionBox" style={this.styles().style} 
		...
		onTouchStart={this.handleClick} onTouchEnd={this.handleMouseDown} onTouchMove={this.handleMouseUp}
		 > 
			<div className="handle tl" onMouseDown={this.handleMouseDownOnResizeHandler}></div>
			<div className="handle t" onMouseDown={this.handleMouseDownOnResizeHandler}></div>
			<div className="handle tr" onMouseDown={this.handleMouseDownOnResizeHandler}></div>
			<div className="handle r" onMouseDown={this.handleMouseDownOnResizeHandler}></div>
			<div className="handle bl" onMouseDown={this.handleMouseDownOnResizeHandler}></div>
			<div className="handle b" onMouseDown={this.handleMouseDownOnResizeHandler}></div>
			<div className="handle br" onMouseDown={this.handleMouseDownOnResizeHandler}></div>
			<div className="handle l" onMouseDown={this.handleMouseDownOnResizeHandler}></div>
			<div className="handle rotate">
				<div className="rotateHandle" onMouseDown={this.handleMouseDownOnRotateHandler}></div>
			</div>
...
class Toolbar extends React.Component {
	...
	render(){
		return <div className="toolbar" onMouseDown={this.handleMousedown}
			onTouchStart={this.handleMousedown}>
		</div>;
	};
	shouldComponentUpdate(nextProps, nextState){
		...
		if(this.props.selectedElement && 
			this.props.selectedElement.classList.contains("editableText") &&
			!$(nextProps.selectedElement).is(this.props.selectedElement)){
				var el = $(this.props.selectedElement).find(".editableContainer").get(0);
				el.setAttribute("contenteditable", false); 
				el.blur();
			}
		if($(this.props.selectedElement).is(nextProps.selectedElement) 
...
class CropBoxView extends React.Component {
	...
	render() {
		return <div className="cropBox" style={this.styles().style.element}>
			<div className="viewPort" style={this.styles().style.viewPort}>
				{this.props.eventType == "dblclick" &&	<div className="innerView" style={this.styles().style.innerView}>
						<img src={this.getImageUrl()} style={this.getImageStyle()} 
						
						onMouseDown={this.handleImageOnMouseDown}
						onTouchStart={this.handleImageOnMouseDown}
						/>
					</div>
				}
			</div>
			<div className="cropBoxHandlers">
				<div className="handle tl" onMouseDown={this.handleMouseDownOnResizeHandler} onMouseMove={this.handleMouseMoveOnResizeHandler}></div>
				<div className="handle tr" onMouseDown={this.handleMouseDownOnResizeHandler} onMouseMove={this.handleMouseMoveOnResizeHandler}></div>
				<div className="handle bl" onMouseDown={this.handleMouseDownOnResizeHandler} onMouseMove={this.handleMouseMoveOnResizeHandler}></div>
				<div className="handle br" onMouseDown={this.handleMouseDownOnResizeHandler} onMouseMove={this.handleMouseMoveOnResizeHandler}></div>
			</div>
		</div>
	}
}
...
class DocumentView extends React.Component {
	...
	render () {
		return <div className="document" style={this.styles().style}  data-id={this.props.data.cid} 
			onMouseDown={this.handleMousedown}
			onTouchStart={this.handleMousedown}>

			<Toolbar selectedElement={ this.state.selectedElement } eventType={this.state.eventType}
			clearMousedownEventFromDocument={this.clearMousedownEventFromDocument} />
			<CropBoxView data={this.props.data} eventType={this.state.eventType} cropBoxElement={this.state.cropBoxElement} cropBoxElementCallback={this.state.cropBoxElementCallback}/>
			<SelectionBoxView data={this.props.data} 
				...
				eventType = {this.state.eventType} />
			{
				...
				this.props.data.get("children").map((multipage) => {
					var cid = multipage.cid;
					return <MultipageView  key={ cid } data={multipage} 
...
// Render html
ReactDOM.render(<DocumentView data={dataModel}/>, document.getElementsByClassName("editorPanel")[0]);
